 ...
 * 曾经的xml的配置:
 *      <bean id="accountService" class="com.lgl.service.impl.AccountServiceImpl" scope="" init-method="" destroy-method="">
 ...
 *      Qualifier:
 *          作用: 在按照类中注入的基础上之上再按照名称注入.它在给类成员注入时不能单独使用.但是在给方法参数注入时可以.
 *          属性:
 *              value: 用于指定注入bean的id.
 *      Resource
 ...
 *----------------------------------------------------------------------------------------------------------------------
 * 用于改变作用范围的
 *      他们的作用就和在xml配置文件中的<bean>标签中使用scope属性实现功能是一样的
 *      Scope
 *          作用: 用于指定bean的作用范围
 *          属性:
 ...
 *----------------------------------------------------------------------------------------------------------------------
 * 和生命周期相关的
 *      他们的作用就和在xml配置文件中的<bean>标签中使用init-method和destroy的作用是一样的
 *      PreDestroy
 *          作用: 用于指定销毁方法
 *      PostConstruct
 *          作用: 用于指定初始化方法
